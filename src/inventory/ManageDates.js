...
class ManageDates extends React.Component {
    ...
    componentWillMount(){
        ...
        request.get(`${server.path}/api/Bills?filter=%7B%22where%22%3A%7B%22day%22%3A%22${day}%22%2C%22month%22%3A%20%22${month}%22%2C%22year%22%3A%22${year}%22%2C%20%22shopId%22%3A%221%22%7D%7D&access_token=${accessToken}`)
        .end((err, bills) => {
            if(bills) {
